...
var mapToArray = require('es5-ext/lib/Object/prototype/map-to-array')
  , hforEach   = require('es5-ext/lib/Object/prototype/for-each')
...
var run = function run (testee, tests, assert, logger) {
	...
	hforEach.call(tests, function (t) {
		var conf, match;
		if (isFunction(t)) {
	...
	return deferred(null)(lock.call(all, mapToArray.call(tests, hold.call(function (f, name) {
		var o, d, finish, done;
		d = deferred();
		finish = function () {
			logger.out();
