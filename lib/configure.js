...
var fs           = require('fs')
  ...
  , deferred     = require('deferred/lib/ext/map')
  , all          = require('deferred/lib/join/all')
  , getFiles     = deferred.bafn(require('next/lib/fs/readdir-files-deep'))
...
module.exports = function (paths) {
	...
	all(paths, hold.call(function (p) {
		...
		(rcurry.call(all, hold.call(function (testee) {
