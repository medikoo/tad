...
var runInContext = require('vm').runInContext
  , findSame  = require('es5-ext/lib/List/find-same-start-length').call.applyArgs
  , match     = require('es5-ext/lib/Function/match').call
  , compact   = require('es5-ext/lib/Array/compact')
...
suite = {
	...
	ondata: function (a, b) {
		this.tail = this.tail(match(this.process).bind(this, arguments));
	},
